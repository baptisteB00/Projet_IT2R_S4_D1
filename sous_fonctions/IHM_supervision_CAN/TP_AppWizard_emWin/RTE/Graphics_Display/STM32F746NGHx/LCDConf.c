...
{
  int TouchLeft, TouchRight, TouchTop, TouchBottom;
  unsigned int Orientation;
    ...
    TouchBottom = 271;
  #elif (ORIENTATION_0 == ROTATION_180)
    Orientation = GUI_MIRROR_X | GUI_MIRROR_Y;
    TouchLeft   = 479;
    TouchRight  = 0;
    TouchTop    = 271;
    TouchBottom = 0;
  #elif (ORIENTATION_0 == ROTATION_CW)
    Orientation = GUI_SWAP_XY | GUI_MIRROR_X;
    TouchLeft   = 0;
    TouchRight  = 271;
    TouchTop    = 479;
    TouchBottom = 0;
  #elif (ORIENTATION_0 == ROTATION_CCW)
    Orientation = GUI_SWAP_XY | GUI_MIRROR_Y;
    TouchLeft   = 271;
    TouchRight  = 0;
    TouchTop    = 0;
    TouchBottom = 479;
  ...
  GUI_TOUCH_Calibrate(GUI_COORD_X, 0, XSIZE_PHYS - 1, TouchLeft,  TouchRight);
  GUI_TOUCH_Calibrate(GUI_COORD_Y, 0, YSIZE_PHYS - 1, TouchTop,   TouchBottom);
}
#endif
}
