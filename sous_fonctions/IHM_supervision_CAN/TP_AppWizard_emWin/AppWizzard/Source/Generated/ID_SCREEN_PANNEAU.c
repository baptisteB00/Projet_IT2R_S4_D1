...
**********************************************************************
----------------------------------------------------------------------
File        : ID_SCREEN_PANNEAU.c
Purpose     : Generated file do NOT edit!
---------------------------END-OF-HEADER------------------------------
*/

#include "Resource.h"
#include "ID_SCREEN_PANNEAU.h"
...
static APPW_CREATE_ITEM _aCreate[] = {
  ...
  { WM_OBJECT_BUTTON_Create,
    ID_BUTTON_NEXT, ID_SCREEN_PANNEAU,
  ...
  { WM_OBJECT_BUTTON_Create,
    ID_BUTTON_ACCUEIL, ID_SCREEN_PANNEAU,
  ...
  { WM_OBJECT_BUTTON_Create,
    ID_BUTTON_PREVIOUS, ID_SCREEN_PANNEAU,
...
static GUI_CONST_STORAGE APPW_SETUP_ITEM _aSetup[] = {
  { ID_BOX_05,          APPW_SET_PROP_COLOR,        { ARG_V(GUI_WHITE) } },
  ...
  { ID_BUTTON_ACCUEIL,  APPW_SET_PROP_COLORS,       { ARG_V(GUI_INVALID_COLOR),
                                                      ARG_V(GUI_INVALID_COLOR),
                                                      ARG_V(GUI_INVALID_COLOR) } },
...
static GUI_CONST_STORAGE APPW_ACTION_ITEM _aAction[] = {
  { ID_BUTTON_ACCUEIL,  WM_NOTIFICATION_CLICKED,          0,                  APPW_JOB_SHIFTSCREEN,    ID_SCREEN_PANNEAU__ID_BUTTON_ACCUEIL__WM_NOTIFICATION_CLICKED,
  ...
  { ID_BUTTON_NEXT,     WM_NOTIFICATION_CLICKED,          0,                  APPW_JOB_SHIFTSCREEN,    ID_SCREEN_PANNEAU__ID_BUTTON_NEXT__WM_NOTIFICATION_CLICKED,
  ...
  { ID_BUTTON_PREVIOUS, WM_NOTIFICATION_CLICKED,          0,                  APPW_JOB_SHIFTSCREEN,    ID_SCREEN_PANNEAU__ID_BUTTON_PREVIOUS__WM_NOTIFICATION_CLICKED,
    { ARG_V(ID_SCREEN_SON),
...
*/
APPW_ROOT_INFO ID_SCREEN_PANNEAU_RootInfo = {
  ID_SCREEN_PANNEAU,
