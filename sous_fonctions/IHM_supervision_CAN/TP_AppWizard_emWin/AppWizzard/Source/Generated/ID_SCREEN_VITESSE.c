...
static APPW_CREATE_ITEM _aCreate[] = {
  ...
  { WM_OBJECT_PROGBAR_Create,
    ID_BATTERIE_JAUGE, ID_SCREEN_VITESSE,
    { { { DISPOSE_MODE_REL_PARENT, 385, 0, 0 },
  ...
  { WM_OBJECT_IMAGE_Create,
    ...
    { { { DISPOSE_MODE_REL_PARENT, 424, 0, 0 },
...
static GUI_CONST_STORAGE APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_BUTTON_PREVIOUS, APPW_SET_PROP_COLORS,       { ARG_V(0xffc0c0c0),
                                                      ARG_V(0xffc0c0c0),
                                                      ARG_V(GUI_INVALID_COLOR) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_RANGE,        { ARG_V(0),
                                                      ARG_V(100) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_VERTICAL,     { ARG_V(0) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_RADIUS,       { ARG_V(5) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_FRAME,        { ARG_V(2) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_COLOR,        { ARG_V(0xff2c2c30) } },
  { ID_BATTERIE_JAUGE,  APPW_SET_PROP_VALUE,        { ARG_V(40) } },
  ...
  { ID_IMAGE_00,        APPW_SET_PROP_SBITMAP,      { ARG_VP(0, acICONE_BATTERIE),
                                                      ARG_V(932), } },
