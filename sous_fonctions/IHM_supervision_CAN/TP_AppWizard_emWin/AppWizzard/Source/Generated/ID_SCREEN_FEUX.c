...
static GUI_CONST_STORAGE APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_IMAGE_00,        APPW_SET_PROP_SBITMAP,      { ARG_VP(0, acsoleil),
                                                      ARG_V(2536), } },
  ...
  { ID_IMAGE_01,        APPW_SET_PROP_SBITMAP,      { ARG_VP(0, acPHARE),
                                                      ARG_V(2614), } },
...
static GUI_CONST_STORAGE APPW_ACTION_ITEM _aAction[] = {
  ...
  { ID_SWITCH_00,       WM_NOTIFICATION_VALUE_CHANGED,    ID_IMAGE_00,        APPW_JOB_SETBITMAP,      ID_SCREEN_FEUX__ID_SWITCH_00__WM_NOTIFICATION_VALUE_CHANGED__ID_IMAGE_00__APPW_JOB_SETBITMAP,
    { ARG_V(0),
      ARG_VP(0, acsoleil),
      ARG_V(2536),
    }, 0, NULL
  },
  { ID_SWITCH_01,       WM_NOTIFICATION_VALUE_CHANGED,    ID_IMAGE_00,        APPW_JOB_SETBITMAP,      ID_SCREEN_FEUX__ID_SWITCH_01__WM_NOTIFICATION_VALUE_CHANGED__ID_IMAGE_00__APPW_JOB_SETBITMAP,
    { ARG_V(0),
      ARG_VP(0, aclune),
      ARG_V(4782),
    }, 0, NULL
